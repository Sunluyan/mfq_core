...
@Component
public class FinanceOrder2App implements Serializable{
	@Resource
	...
	public FinanceOrder2App() {
		super();
	}

	//普通订单
	public FinanceOrder2App(com.mfq.bean.Product product, OrderInfo orderInfo, FinanceBill financeBill , String hospital_name, PolicyStatus policy_status) {
		if(financeBill == null){
