  ...
  <tr>
    <td height="60" align="center" valign="middle" class="down_line"><table width="96%" border="0" cellspacing="0" cellpadding="3">
      ...
      <tr>
        ...
        <td align="right" valign="top"><table border="0" cellpadding="1" cellspacing="0" class="round_l">
          <tr>
            <td align="center" valign="middle"><span class="STYLE9"><span class="STYLE7"> 补贴</span>|</span></td>
            <td align="left" valign="middle"><span class="STYLE6"><fmt:formatNumber  value="${product.marketPrice - product.price}" pattern="###,###" /></span></td>
          </tr>
        </table></td>
        </tr>
    </table></td>
