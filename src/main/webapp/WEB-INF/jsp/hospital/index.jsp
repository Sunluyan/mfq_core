...
.point{background:rgba(255,255,255,.95);
	position:absolute;
	bottom:0;
	left:0;
	right:0;
...
<a href="#">
<div class="boxs">
<script type="text/javascript" src="/js/activity/jquery-1.8.2.min.js"></script>	<div class="box">
		<img class="bg hosimg" src="../../images/hospital/img/mei-bg.jpg" alt="背景" draggable="false">
		<div class="point">
			<div class="left hosname">上海艺星医疗美容医院<div>
			<img src="../../images/hospital/img/add_01.png" class="add-icon"><span class="hosaddress">地址：上海市长宁区虹桥路1165号</span></div></div>
		</div>
	</div>
	<div class="boxs-icon">
		<div class="boxs-fix">
