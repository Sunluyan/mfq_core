...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/css/activity/newyear/index.css" >
    <title>丑女小美变美记</title>
...
<div class="demoBox">
    <div class="demo">
        <canvas><img id="lamp" src="http://7xlb4j.com2.z0.glb.qiniucdn.com/newyear%2Fimgchou.png" height="546" width="537"></canvas>
    </div>
</div>
<script type="text/javascript">
    ...
    var imgs = "http://7xlb4j.com2.z0.glb.qiniucdn.com/newyear%2Fimgmei.png";  //刮开后显示的底图
    // var num = Math.floor(Math.random()*2);  //2张刮开后图片 随机
    img.src = imgs;
    img.addEventListener('load', function(e){
        ...
        var mousedown = false;
        // var pat=ctx.createPattern('img/chou.png',"repeat");
        ...
        success:function(json){
            ...
            wx.ready(function(){
                ...
                wx.onMenuShareTimeline({
                    ...
                    success: function () {
                        // 用户确认分享后执行的回调函数
                        location.href = "/activity/newyear/four";
                    },
                    cancel: function () {
                        // 用户取消分享后执行的回调函数
                        alert("取消就没有红包了哦")
                ...
                wx.onMenuShareAppMessage({
                    title: '圣诞元旦-拯救丑女大作战! 500红包等你拿!', // 分享标题
                    desc: '', // 分享描述
                    link: 'http://m.5imfq.com/activity/newyear/one', // 分享链接
                    imgUrl: 'http://7xlcaq.com2.z0.glb.qiniucdn.com/Chrismas.jpg', // 分享图标
                    type: 'link', // 分享类型,music、video或link，不填默认为link
                    dataUrl: '', // 如果type是music或video，则要提供数据链接，默认为空
                    success: function () {
                        // 用户确认分享后执行的回调函数
                        location.href = "/activity/newyear/fours";
                    },
                    cancel: function () {
                        // 用户取消分享后执行的回调函数
                    }
